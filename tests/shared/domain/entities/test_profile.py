...
class Test_Profile:
  ...
  def test_role_not_enum(self):
    with pytest.raises(EntityError):
      Profile(user_id="00000000-0000-0000-0000-000000000000", entity_id="00000000-0000-0000-0000-000000000000", game_data_id="00000000-0000-0000-0000-000000000000", affiliations=["00000000-0000-0000-0000-000000000000"], wallet_id="00000000-0000-0000-0000-000000000000", role="ADMIN", created_at=1, updated_at=1)
